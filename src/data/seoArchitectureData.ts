...
export const UK_LOCAL_STORES = [
  {
    id: 'london-flagship',
    city: 'London',
    name: 'Apex Ebikes UK - London Showroom & Test Ride Centre',
    streetAddress: '142-144 Old Street, Shoreditch',
    addressLocality: 'London',
    postalCode: 'EC1V 9BW',
    addressCountry: 'GB',
    telephone: '+44 20 7946 0888',
    email: 'london@apexebikes.co.uk',
  ...
  },
  {
    id: 'manchester-hub',
    city: 'Manchester',
    name: 'Apex Ebikes UK - Manchester Regional Hub',
    streetAddress: 'Unit 4, Great Ancoats Street',
    addressLocality: 'Manchester',
    postalCode: 'M4 5AB',
    addressCountry: 'GB',
    telephone: '+44 161 832 9400',
    email: 'manchester@apexebikes.co.uk',
  ...
  },
  {
    id: 'bristol-centre',
    city: 'Bristol',
    name: 'Apex Ebikes UK - Bristol Hill-Test & Service Centre',
    streetAddress: '78 Gloucester Road, Bishopston',
    addressLocality: 'Bristol',
    postalCode: 'BS7 8BN',
    addressCountry: 'GB',
    telephone: '+44 117 942 5500',
    email: 'bristol@apexebikes.co.uk',
