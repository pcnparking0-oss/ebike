...
export const UK_LOCAL_STORES = [
  {
    id: 'london-flagship',
    city: 'London',
    name: 'VoltTrail UK - London Electric Dirt Bike Hub',
    streetAddress: '142-144 Old Street, Shoreditch',
    addressLocality: 'London',
    postalCode: 'EC1V 9BW',
    addressCountry: 'GB',
    telephone: '+44 20 7946 0888',
    email: 'london@volttrail.co.uk',
  ...
  },
  {
    id: 'manchester-hub',
    city: 'Manchester',
    name: 'VoltTrail UK - Manchester Electric Dirt Bike Hub',
    streetAddress: 'Unit 4, Great Ancoats Street',
    addressLocality: 'Manchester',
    postalCode: 'M4 5AB',
    addressCountry: 'GB',
    telephone: '+44 161 832 9400',
    email: 'manchester@volttrail.co.uk',
  ...
  },
  {
    id: 'bristol-centre',
    city: 'Bristol',
    name: 'VoltTrail UK - Bristol Electric Dirt Bike & Test Centre',
    streetAddress: '78 Gloucester Road, Bishopston',
    addressLocality: 'Bristol',
    postalCode: 'BS7 8BN',
    addressCountry: 'GB',
    telephone: '+44 117 942 5500',
    email: 'bristol@volttrail.co.uk',
